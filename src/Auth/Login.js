    ...
    const sendRequest = async() => {
        await fetch('http://bookstore.rtcserver.cloud/login/0', {
            ...
            if (json.status === 'success'){
                ...
                window.localStorage.setItem("id", json.id_pengguna);
                window.localStorage.setItem("nama", json.nama);
                    ...
                    <div className="row m-t-25 text-left">
                        <div className="col-12">
                            <div className="forgot-phone text-left f-left">
                                <a href="/auth/register" className="text-left f-w-600"> Create account</a>
                            </div>
                            <div className="forgot-phone text-right f-right">
                                <a href="/auth/forgot" className="text-right f-w-600"> Forgot Password?</a>
                            </div>
                        </div>
                    </div>
